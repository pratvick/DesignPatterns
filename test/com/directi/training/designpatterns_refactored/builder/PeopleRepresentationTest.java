...
public class PeopleRepresentationTest
{
    ...
    public void testPeopleXml()
    {
        ...
        AbstractBuilder builder = new XmlBuilder();
        String expectedXml = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>" +
                             "<people number=3>" +
                                ...
                                "</person>" +
                             "</people>";
        assertEquals(expectedXml, PeopleRepresentation.constructRepresentation(persons, builder));
    }
    ...
    public void testPeopleJson()
    {
        ...
        persons.add(new Person("Kobayashi", 200, "Kanto", "Japan"));
        persons.add(new Person("Vasily", 1, "Leningrad", "Russia"));
        AbstractBuilder builder = new JsonBuilder();
        String expectedJson = "people:" +
                              ...
                              "}" +
                              "]";
        assertEquals(expectedJson, PeopleRepresentation.constructRepresentation(persons, builder));
    }
}